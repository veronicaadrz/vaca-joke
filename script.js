...
function showMessage(response) {
   /* if (response === "No") {
    ...
    if (response === "Yes") {
        ...
        yesMessage.textContent = "siuuuu saka pues";
...
/*         videoElement.setAttribute("width", "320"); */
        ...
        videoElement.setAttribute("src", "images/vacaPolacaBailando.mp4");
...
noButton.addEventListener ("click", () => {
    ...
    const noMessage = document.getElementById("question");
        noMessage.textContent = "kola pues";
